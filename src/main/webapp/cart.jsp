				...
				<div style="margin:0 auto; margin-top:10px;width:950px;">
					...
					<table class="table table-bordered">
						<tbody>
							...
							<c:forEach items="${sessionScope.catr}" var="cartMap">
							<tr class="active">
								...
								<td width="30%">
									<a target="_blank">${cartMap.value.pname}</a>
								</td>
								<td width="20%">
									￥${cartMap.value.shop_price}
								</td>
								<td width="10%">
								...
								<td>
									<a href="product?mathod=deleteCartById&pid=${cartMap.key}" class="delete">删除</a>
								</td>
							</tr>
							</c:forEach>
						</tbody>
				...
				<div style="text-align:right;margin-top:10px;margin-bottom:10px;">
					...
					<a href="order_info.htm">
						<form action="product" method="post">
							<input type="hidden" name="method" value="commitOrder"
