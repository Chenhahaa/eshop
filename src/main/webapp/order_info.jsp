			...
			<div style="margin: 0 auto; margin-top: 10px; width: 950px;">
				...
				<table class="table table-bordered">
					<tbody>
						...
						<c:forEach items="${sessionScope.cart}" var="cartMap">
						<tr class="active">
							<td width="60" width="40%"><input type="hidden" name="id"
								value="22"> <img src="${cartMap.value.pimage}" width="70"
								height="60"></td>
							<td width="30%"><a target="_blank">${cartMap.value.pname}</a></td>
							<td width="20%">￥${cartMap.value.shorp_price}</td>
							<td width="10%">${cartMap.value.count}</td>
							<td width="15%"><span class="subtotal">￥${cartMap.value.shorp_price*cartMap.value.count}</span></td>
						</tr>
						</c:forEach>
					</tbody>
				</table>
		...
		<div>
			<hr />
				...
				<div class="form-group">
					...
					<div class="col-sm-5">
						<input type="password" class="form-control" id="inputPassword3" name="name" value="${user.username}"
							placeholder="请输收货人">
					</div>
				</div>
				<div class="form-group">
